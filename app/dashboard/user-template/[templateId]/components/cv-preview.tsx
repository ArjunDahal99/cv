...
const CvPreview = () =>
{
    ...
    const { body, subject, fileName, filePath } = useCVTemplateStore()
        ...
        <div className="   lg:w-[600px] max-md:w-full min-h-[80vh] h-[80vh] rounded-lg  dark:border-2  shadow-md ">
            ...
            <div className=" overflow-hidden">
                <div className="  p-5 ">
                    {fileName && filePath && (
                        <div className=' w-fit ' >
                            <a target="_blank" rel="noopener noreferrer" href={filePath} className=' flex flex-col justify-center items-center '>
